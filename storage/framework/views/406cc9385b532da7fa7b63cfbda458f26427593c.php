        ...
        <div class="col-md-6 col-md-offset-0">
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                         ...
                         <?php echo Form ::open (['route'=>'pegawai.store','files'=>'true']); ?>
            ...
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                        ...
                        <div class="form-group<?php echo e($errors->has('jabatan_id') ? ' has-error' : ''); ?>">
                            ...
                            <div class="col-md-6">
                                <input id="jabatan_id" type="text" class="form-control" name="jabatan_id" value="<?php echo e(old('jabatan_id')); ?>" required>
