            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                     <div class="col-lg-12">
                        ...
                        <a href="<?php echo e(url('jabatan/create')); ?>" class="btn btn-primary"><i>Tambah Data</a></i>
                            ...
                            <table class="table table-bordered table-hover">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td><center><a title="Melihat detail data" href="<?php echo e(url('jabatan',$data->id)); ?>" class="btn btn-primary"><i class="glyphicon glyphicon-eye-open"> Detail</a></i>

                                        <a title="Mengubah Data" href="<?php echo e(route('jabatan.edit',$data->id)); ?>" class="btn btn-success"><i class="fa fa-edit"> Edit</a></i>
                                        ...
                                        <?php echo $__env->make('hapus.delete',['url'=>route('jabatan.destroy',$data->id),'model'=>$data], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                                        </center>
                                        </td>
                                    </tr>
