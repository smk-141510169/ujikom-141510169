            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                       ...
                       <div class="form-group">
                           ...
                           <div class="col-sm-10">
                               <input type="text" class="form-control" id="id" placeholder="{{$jabatan->kode_jabtan}}" readonly>
                           </div>
                       </div>
                       <div class="form-group">
                           <label for="id" class="col-sm-12 control-label">Nama Jabatan </label>
                           <div class="col-sm-10">
                               <input type="text" class="form-control" id="id" placeholder="{{$jabatan->nama_jabatan}}" readonly>
                           </div>
                       </div>
                       <div class="form-group">
                            <div class="col-sm-10">
